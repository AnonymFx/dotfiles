...
LOCK_CMD="i3lock --nofork --screen=0 --color=000000 --insidevercolor=00000000 --insidewrongcolor=00000000 --insidecolor=00000000 --ringvercolor=2C2C2CFF --ringwrongcolor=0A0A0AFF --ringcolor=0A0A0AFF --linecolor=00000000 --keyhlcolor=FFFFFFFF --bshlcolor=2C2C2CFF --textcolor=00000000 --veriftext="" --wrongtext="" --radius=$IND_RADIUS --indpos=$IND_POS_X:$IND_POS_Y"
