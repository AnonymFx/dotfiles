		...
		"Arch Linux")
			case $TARGET in
				...
				gtk )
					...
					;;
				i3-gaps )
					echo "i3-gaps gnome-screensaver xautolock dmenu rofi compton feh autorandr-git udevil gnome-keyring libnotify xdotool imagemagick playerctl network-manager-applet insync polkit polkit-gnome xdg-user-dirs python python-rofi i3ipc-python rofimoji-git paprefs"
					return 0
					;;
				ideavim )
					echo ""
